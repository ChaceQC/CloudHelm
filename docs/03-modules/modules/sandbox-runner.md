...
创建、销毁、清理 Docker sandbox，挂载仓库工作区。

## 技术栈

Docker Engine + workspace manager + resource limits。

## 上游依赖

Repo Tool、Sandbox Tool、Agent Runtime。

## 主要输出

命令输出、测试报告、artifact、sandbox session 状态。
