...
`<role_contract>` 指定 Requirement、Architect、Planner、Coder、Tester、
Reviewer、Security、Release、Deploy 或 SRE 等职责。角色名称只表示本轮职责，
...
Requirement、Architect、Planner 当前可能使用的字段集合；当前 turn 的必填项、
嵌套结构、ID、引用和业务规则仍由
